...
class DroneCategoryTests(APITestCase): 
    ...
    def test_filter_drone_category_by_name(self): 
        ...
        url = '{0}?{1}'.format( reverse(views.DroneCategoryList.name), 
...
class PilotTests(APITestCase): 
    ...
    def test_post_and_get_pilot(self): 
        """ 
        Ensure we can create a new Pilot and then retrieve it Ensure we cannot retrieve the persisted pilot without a token 
        """ 
